...
<script type="text/javascript" src="${pageContext.request.contextPath}/ch06/client/js/form.js"></script>
</head>
<body class="main">
<!-- 1.网上书城顶部 start -->
...
<!-- 3.网上书城用户注册  start -->
	<div id="divcontent" align="center">
		<form action="${pageContext.request.contextPath}/ch06/client/registersuccess.jsp" method="post" onsubmit="return checkForm();">
